...
const ALL_TAGLINES = [
    ...
    'Факс не спрашивал разрешений и не собирал данные. Мы тоже.',
    'Пока другие изобретают колесо, мы просто едем.',
    'Три сервера упали. Один факс — нет.',
    'Простота — главное достижение прогресса. К ней мы и вернулись.',
    'Тогда говорили: «отправь факсом» — и всё приходило. Так и сейчас.',
    'Ретро — это не стиль. Это когда всё работает.',
    'Там, где у других «503 Service Unavailable», у нас — тихий гудок и доставка.',
    'Сложные технологии — для сложных проблем. У нас простая задача: доставить сообщение.',
    'Мессенджеры нового поколения падают по старым причинам. Факс таких причин не знал.',
    'Архивный подход. Современная скорость.',
    'Нас не нужно обновлять. Мы и так работаем.',

    // Игра на «послать по факсу»
    'Хочется кого-то послать? Отправь по FAX — вежливо и с подтверждением доставки.',
    'Посылать людей — это искусство. FAX поможет сделать это официально.',
    'Послать по факсу — звучит культурно. Принять сигнал на той стороне — их проблемы.',
    'Факс всегда знал, куда послать. Мы переняли традицию.',
    'Не грубите лично. Пошлите по факсу — технично и с историей переписки.',
    'Иногда лучший ответ — это FAX. Быстро, ясно, без лишних слов.',
];
