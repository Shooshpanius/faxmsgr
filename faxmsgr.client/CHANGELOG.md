...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest faxmsgr.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`faxmsgr.client.esproj`).
